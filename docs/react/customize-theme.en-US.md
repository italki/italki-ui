...
+     options: {
+       modifyVars: {
+          'hack': `true;@import "${require.resolve('@italki/ui/lib/style/color/colorPalette.less')}";`,
+          ...darkThemeVars,
+       },
+       javascriptEnabled: true,
+     },
...
#antd { @import '~@italki/ui/es/style/core/index.less'; @import '~@italki/ui/es/style/themes/default.less'; }
```
