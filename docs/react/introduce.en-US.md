...
- Manually import
  ...
  ```jsx
  import DatePicker from '@italki/ui/es/date-picker'; // for js
  import '@italki/ui/es/date-picker/style/css'; // for css
  // import '@italki/ui/es/date-picker/style';         // that will import less
  ```
