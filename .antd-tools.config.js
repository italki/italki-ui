...
function finalizeCompile() {
  if (fs.existsSync(path.join(__dirname, './lib'))) {
    ...
    // Build a entry less file to dist/italki-ui.less
...
function finalizeDist() {
  if (fs.existsSync(path.join(__dirname, './dist'))) {
    // Build less entry file: dist/italki-ui.less
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'italki-ui.less'),
      '@import "../lib/style/index.less";\n@import "../lib/style/components.less";',
    );

    // eslint-disable-next-line
    console.log('Built a entry less file to dist/italki-ui.less');

    // Build less entry file: dist/italki-ui.dark.less
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'italki-ui.dark.less'),
      '@import "../lib/style/dark.less";\n@import "../lib/style/components.less";',
    );

    // eslint-disable-next-line
    console.log('Built a entry less file to dist/italki-ui.dark.less');
