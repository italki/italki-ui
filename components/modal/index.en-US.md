...
| footerNoDivider | The divider line between Footer and Body | boolean | false |
...
| fullscreen | make modal fullscreen | boolean | false |
| responsive | if screen size is small than 768px modal will be full screen | boolean | false |
