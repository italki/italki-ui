...
class Tag extends React.Component<TagProps, TagState> {
  ...
  setVisible(visible: boolean, e: React.MouseEvent<SVGSVGElement>) {
  ...
  handleIconClick = (e: React.MouseEvent<SVGSVGElement>) => {
    e.stopPropagation();
  ...
  //   return closable ? <Cross onClick={this.handleIconClick} /> : null;
  // }
